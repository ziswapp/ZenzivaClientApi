...
final class RegularTest extends TestCase
{
    ...
    public function testCanSendSmsXmlResponse(): void
    {
        $responses = [
    ...
    public function testCanThrowExceptionWithXmlResponse(): void
    {
    ...
    public function testCanThrowExceptionWithXmlResponseAndErrorCode(): void
    {
        $this->expectException(ZenzivaRequestException::class);
        $this->expectExceptionMessage('Userkey / Passkey Salah');

        $responses = [
            new MockResponse(\file_get_contents(__DIR__ . '/stubs/error-regular.xml'), [
                'http_code' => 400,
            ]), ];
    ...
    public function testCanThrowExceptionWithJsonResponse(): void
    {
        $this->expectException(ZenzivaRequestException::class);
        $this->expectExceptionMessage('Userkey / Passkey Salah');
    ...
    public function testCanThrowExceptionWithJsonResponseAndErrorCode(): void
    {
        $this->expectException(ZenzivaRequestException::class);
        $this->expectExceptionMessage('Userkey / Passkey Salah');

        $responses = [
            new MockResponse(\file_get_contents(__DIR__ . '/stubs/error-regular.json'), [
                'http_code' => 400,
            ]), ];
